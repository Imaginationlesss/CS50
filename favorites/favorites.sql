...
UPDATE shows SET title = "How I Meet Your Mother" WHERE title LIKE "How I Meet Your Mother";
UPDATE shows SET title = "It's Always Sunny In Philadelphia" WHERE title LIKE "It's Always Sunny In Philadelphia";
UPDATE shows SET title = "Parks and Recreation" WHERE title LIKE "Parks and Recration";
...
UPDATE shows SET title = "It's Always Sunny In Philadelphia" WHERE title LIKE "It's Always%"
